...
(function (RP) {
  ...
  var api = RP.api = {
    ...
    pantipRadar: function (o) { return api._post('/api/pantip-radar', o); },
    pantipReply: function (o) { return api._post('/api/pantip-reply', o); },
    socialRadar: function (o) { return api._post('/api/social-radar', o); },
    backlinkGaps: function (o) { return api._post('/api/backlink-gaps', o); },
    ...
    imwebPrefill: function (o) { return api._post('/api/imweb/prefill', o); },
    ...
    toFacebook: function (pid, o) { return api._post('/api/projects/' + pid + '/to-facebook', o || {}); },
    getSms: function (pid) { return api._get('/api/projects/' + pid + '/sms'); },
    ...
    siteCheck: function (url, keywords, business) { return api._post('/api/site-check', { url: url, keywords: keywords || [], business_name: business || '', deep: true }); },
    ...
    citationExamples: function (pid) { return api._get('/api/projects/' + pid + '/citation/examples'); },
    projectBacklinks: function (pid) { return api._post('/api/projects/' + pid + '/backlinks', {}); },
