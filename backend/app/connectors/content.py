...
กฎ (ห้ามละเมิด):
- เปิดด้วย <p> answer-first 40-60 คำ ตอบคำถามหลักตรง ๆ; ถ้าหัวข้อเป็น how-to/เปรียบเทียบ/คู่มือยาว ตามด้วย <ul> 'ประเด็นสำคัญ' 3-5 ข้อ แต่ละข้อเป็นข้อเท็จจริงกระชับ quotable (ตัวเลข/เกณฑ์/ข้อสรุป) แล้วจึงขึ้น <h2> ตัวแรก
