...
COLUMN_DDL = [
    ...
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS aeo_questions TEXT DEFAULT ''",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS cta_json TEXT DEFAULT ''",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS report_token VARCHAR(64) DEFAULT ''",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS ai_competitors TEXT DEFAULT ''",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS backlink_state TEXT DEFAULT ''",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS site_brief TEXT DEFAULT ''",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS site_token VARCHAR(64) DEFAULT ''",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS site_variant INTEGER DEFAULT 0",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS is_hub BOOLEAN DEFAULT false",
    "ALTER TABLE web_requests ADD COLUMN IF NOT EXISTS address VARCHAR(400) DEFAULT ''",
    "ALTER TABLE web_requests ADD COLUMN IF NOT EXISTS map_url VARCHAR(600) DEFAULT ''",
    "ALTER TABLE web_requests ADD COLUMN IF NOT EXISTS menu_text TEXT DEFAULT ''",
    "ALTER TABLE uploaded_images ADD COLUMN IF NOT EXISTS kind VARCHAR(20) DEFAULT 'gallery'",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS keyword_pack INTEGER DEFAULT 50",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS sms_enabled BOOLEAN DEFAULT false",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS sms_to VARCHAR(40) DEFAULT ''",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS active BOOLEAN DEFAULT true",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS lead_line_to VARCHAR(80) DEFAULT ''",
    "ALTER TABLE projects ADD COLUMN IF NOT EXISTS lead_email VARCHAR(255) DEFAULT ''",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS phone VARCHAR(60) DEFAULT ''",
    "ALTER TABLE leads ADD COLUMN IF NOT EXISTS message TEXT DEFAULT ''",
    "ALTER TABLE lead_magnets ADD COLUMN IF NOT EXISTS language VARCHAR(20) DEFAULT 'th'",
    "ALTER TABLE lead_magnets ADD COLUMN IF NOT EXISTS error VARCHAR(300) DEFAULT ''",
    "ALTER TABLE lead_magnets ADD COLUMN IF NOT EXISTS stage VARCHAR(120) DEFAULT ''",
